...
def user_api_view(request):
    ...
    # Create
        ...
        if user_serializer.is_valid():
            ...
            return Response({'message': 'Usuario creado correctamente', 'data': user_serializer.data}, status=status.HTTP_201_CREATED)
...
def user_detail_api_view(request, pk=None):
    ...
    return Response({'message': 'No se ha encontrado un usuarios con estos datos'}, status=status.HTTP_404_NOT_FOUND)
