...
# CategoryProductSerializer, MeasurUnitSerializer,)
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    """
    SEGUNDO METODO PARA MOSTRAR DATOS DE UNA LLAVE FORANEA
    MEDIANTE EL METODO __str__ DEL MODEL
    """
    ...
    """
    TERCER METODO PARA MOSTRAR DATOS DE UNA LLAVE FORANEA
    MEDIANTE EL METODO to_representation
    """
    ...
    def to_representation(self, instance):
        return {
            ...
            if instance.category_product is not None
            else "",
        }
